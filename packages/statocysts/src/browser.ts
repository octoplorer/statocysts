...
export const senderRegistry = buildSenderRegistry([bark, json, qqbot, serverChan, jsons, slack, telegram, discord, lark])
...
export { bark, discord, json, lark, qqbot, slack, telegram }
export * from './shared'
