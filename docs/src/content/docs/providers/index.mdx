...
A notification target’s protocol selects its provider. Compare the built-in integrations below, then open a provider page for tested URL formats, query parameters, and direct-call options.
