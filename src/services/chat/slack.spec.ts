  ...
  describe('bot API format', () => {
    it('should build a request with Bot API token', async () => {
      const request = buildSlackRequest(
        new URL('slack://xoxb:123456789012-1234567890123-4mt0t4l1YL3g1T5L4cK70k3N@C001CH4NN3L'),
        'Hello, world!',
      )

      expect(request.method).toBe('POST')
      expect(request.url).toBe('https://slack.com/api/chat.postMessage')
      expect(request.headers.get('Authorization')).toBe('Bearer xoxb-123456789012-1234567890123-4mt0t4l1YL3g1T5L4cK70k3N')
    ...
    it('should build a request with botname parameter', async () => {
      const request = buildSlackRequest(
        new URL('slack://xoxb:123456789012-1234567890123-4mt0t4l1YL3g1T5L4cK70k3N@C001CH4NN3L?botname=TestBot'),
        'Hello, world!',
      )
    ...
    it('should build a request with icon emoji parameter', async () => {
      const request = buildSlackRequest(
        new URL('slack://xoxb:123456789012-1234567890123-4mt0t4l1YL3g1T5L4cK70k3N@C001CH4NN3L?icon=%3Arobot_face%3A'),
        'Hello, world!',
      )
    ...
    it('should build a request with icon URL parameter', async () => {
      const request = buildSlackRequest(
        new URL('slack://xoxb:123456789012-1234567890123-4mt0t4l1YL3g1T5L4cK70k3N@C001CH4NN3L?icon=https%3A%2F%2Fexample.com%2Ficon.png'),
        'Hello, world!',
      )
    ...
    it('should build a request with color parameter', async () => {
      const request = buildSlackRequest(
        new URL('slack://xoxb:123456789012-1234567890123-4mt0t4l1YL3g1T5L4cK70k3N@C001CH4NN3L?color=good'),
        'Hello, world!',
      )
    ...
    it('should build a request with title parameter', async () => {
      const request = buildSlackRequest(
        new URL('slack://xoxb:123456789012-1234567890123-4mt0t4l1YL3g1T5L4cK70k3N@C001CH4NN3L?title=Test+Title'),
        'Hello, world!',
      )
    ...
    it('should build a request with thread_ts parameter', async () => {
      const request = buildSlackRequest(
        new URL('slack://xoxb:123456789012-1234567890123-4mt0t4l1YL3g1T5L4cK70k3N@C001CH4NN3L?thread_ts=1234567890.123456'),
        'Hello, world!',
      )
    ...
    it('should build a request with multiple parameters', async () => {
      const request = buildSlackRequest(
        new URL('slack://xoxb:123456789012-1234567890123-4mt0t4l1YL3g1T5L4cK70k3N@C001CH4NN3L?botname=TestBot&icon=%3Arobot_face%3A&color=warning&title=Alert'),
        'Hello, world!',
      )
